 ...
 */
	...
	class beko_Enqueue{
		...
		public function beko_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'beko_frontend_enqueue_scripts', ) );
		}

		public function beko_frontend_enqueue_scripts( ){
