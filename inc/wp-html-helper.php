...
// image default alt
if( !function_exists( 'beko_img_default_alt' ) ){
	function beko_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'beko_img_tag' ) ){
	function beko_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'beko_anchor_tag' ) ){
	function beko_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'beko_heading_tag' ) ){
	function beko_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'beko_paragraph_tag' ) ){
	function beko_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'beko_other_tag' ) ){
	function beko_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'beko_button_element ' ) ){
	function beko_button_element( array $args ){
