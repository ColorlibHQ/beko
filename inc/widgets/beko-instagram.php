...
----------------------------------------*/
class beko_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('beko_instagram_photo',esc_html__('[ Beko ] Intagram Photo','beko'),array(
			'description' => esc_html__('Beko Instagram Photo Widget','beko'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'beko');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'beko'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'beko'); ?></label>
...
if(!function_exists('beko_instagram_widgets')):
	function beko_instagram_widgets(){
		register_widget('beko_instagram_photo');
	}
	add_action('widgets_init','beko_instagram_widgets');
endif;
