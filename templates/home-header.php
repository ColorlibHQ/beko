    ...
    <div class="col-full">
        <div class="featured">
            ...
            <div class="featured__column featured__column--big">
                <?php 
                $term = beko_opt( 'beko_featured_cat' );
                ...
                ?>
                    <div class="entry" <?php echo beko_inline_bg_img( get_the_post_thumbnail_url() ); ?>>
                        
                        <div class="entry__content">
                            <?php 
                            if( beko_featured_post_cat() ){
                                echo '<span class="entry__category">'.beko_featured_post_cat().'</span>';
                            }
                            ?>
