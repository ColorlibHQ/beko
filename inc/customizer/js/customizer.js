(function( $ , api){
    ...
    api.section( 'beko_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'beko_about_section' , function( section ){
    ...
    api.section( 'beko_blog_section' , function( section ){
    ...
    api.section( 'beko_portfolio_section' , function( section ){
    ...
    api.section( 'beko_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-beko_contact_custom_formshortcode'),
                selector = $('#_customize-input-beko_contact_formshortcode');
    ...
    // General section
    api.section( 'beko_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#beko_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-beko_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-beko_preloader_color' );
            ...
            var $backtotop          = $( '#beko_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-beko_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-beko_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'beko_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#beko_footer_widget_toggle');
